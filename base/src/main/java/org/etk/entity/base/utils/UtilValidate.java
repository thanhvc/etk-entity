 ...
 * especially input. See detailed description below. <br/>
 * SUMMARY <br/>
 * <br/>
 * This is a set of meethods for validating input. Functions are provided to
 * validate: <br/>
 * - U.S. and international phone/fax numbers <br/>
 * - U.S. ZIP codes(5 or 9 digit postal codes) <br/>
 * - U.S. Postal Codes(2 letter abbreviations for names of states) <br/>
 * - U.S. Social Security Numbers(abbreviated as SSNs) <br/>
 * - email addresses <br/>
 * - dates(entry of year, month, and day and validity of combined date) <br/>
 * - credit card numbers <br/>
 * <br/>
 * Supporting utility functions validate that: <br/>
 * - characters are Letter, Digit, or LetterOrDigit <br/>
 * - strings are a Signed, Positive, Negative, Nonpositive, or Nonnegative
 * integer <br/>
 * - strings are a Float or a SignedFloat <br/>
 * - strings are Alphabetic, Alphanumeric, or Whitespace <br/>
 * - strings contain an integer within a specified range <br/>
 * <br/>
 * Other utility functions are provided to: <br/>
 * - remove from a string characters which are/are not in a "bag" of selected
 * characters <br/>
 * - strip whitespace/leading whitespace from a string <br/>
 * <br/>
 * ============================================================================
 * == <br/>
 * NOTE: This code was adapted from the Netscape JavaScript form validation
 * code, <br/>
 * usually found in "FormChek.js". Credit card verification functions Originally <br/>
 * included as Starter Application 1.0.0 in LivePayment. <br/>
 * ============================================================================
 * ==
 * 
 */
...
public class UtilValidate {
  ...
  /**
   * boolean specifying by default whether or not it is okay for a String to be
   * empty
   */
  ...
  /**
   * characters which are allowed in international phone numbers(a leading + is
   * OK)
   */
  ...
  /**
   * Valid U.S. Postal Codes for states, territories, armed forces, etc. See
  ...
  /**
   * Returns true if character c is an English letter (A .. Z, a..z). NOTE: Need
   * i18n version to support European characters. This could be tricky due to
   * different character sets and orderings for various languages and platforms.
   */
  ...
  /**
   * Returns true if all characters are numbers; first character is allowed to
   * be + or - as well. Does not accept floating point, exponential notation,
   * etc.
   */
  public static boolean isSignedInteger(String s) {
    ...
    // if (isSignedInteger.arguments.length > 1) secondArg =
    // isSignedInteger.arguments[1];
   ...
   * true for unsigned integers. If you wish to distinguish between integers and
   * floating point numbers, first call isInteger, then call isFloat. Does not
   ...
   * First character is allowed to be + or -. Also returns true for unsigned
   * integers. If you wish to distinguish between integers and floating point
   * numbers, first call isSignedInteger, then call isSignedFloat.
   */
  public static boolean isSignedFloat(String s) {
    ...
    // The old way:
    // int startPos = 0;
    // if (isSignedFloat.arguments.length > 1) secondArg =
    // isSignedFloat.arguments[1];
    // skip leading + or -
    // if ((s.charAt(0) == "-") ||(s.charAt(0) == "+")) startPos = 1;
  ...
  /**
   * Returns true if string s is letters only. NOTE: This should handle i18n
   * version to support European characters, etc. since it now uses
   * Character.isLetter()
   */
  ...
  /**
   * Returns true if string s is English letters (A .. Z, a..z) and numbers
   * only. NOTE: Need i18n version to support European characters. This could be
   * tricky due to different character sets and orderings for various languages
   * and platforms.
   */
  ...
  /**
   * isSSN returns true if string s is a valid U.S. Social Security Number. Must
   * be 9 digits.
   */
  ...
  /**
   * isUSPhoneNumber returns true if string s is a valid U.S. Phone Number. Must
   * be 10 digits.
   */
  ...
  /**
   * isUSPhoneAreaCode returns true if string s is a valid U.S. Phone Area Code.
   * Must be 3 digits.
   */
  ...
  /**
   * isUSPhoneMainNumber returns true if string s is a valid U.S. Phone Main
  ...
  /**
   * isZIPCode returns true if string s is a valid U.S. ZIP code. Must be 5 or 9
   * digits only.
   */
  ...
  /**
   * Returns true if string s is a valid contiguous U.S. Zip code. Must be 5 or
   * 9 digits only.
   */
  ...
  /**
   * Return true if s is a valid contiguous U.S. Postal Code (abbreviation for
   * state).
   */
  ...
  /**
   * isYear returns true if string s is a valid Year number. Must be 2 or 4
   * digits only. For Year 2000 compliance, you are advised to use 4-digit year
   * numbers everywhere.
   */
  ...
  /**
   * isIntegerInRange returns true if string s is an integer within the range of
   * integer arguments a and b, inclusive.
   */
  ...
  /**
   * Given integer argument year, returns number of days in February of that
   * year.
   */
  ...
  /**
   * isDate returns true if string arguments year, month, and day form a valid
   * date.
   */
  ...
  /**
   * isDate returns true if string argument date forms a valid date and is after
   * today.
   */
  public static boolean isDateAfterToday(String date) {
    ...
    if (dateSlash1 == dateSlash2) {
      // consider the day to be optional; use the first day of the following
      // month for comparison since this is an is after test
  ...
  /**
   * isDate returns true if string argument date forms a valid date and is
   * before today.
   */
  public static boolean isDateBeforeToday(String date) {
    ...
    if (dateSlash1 <= 0)
      return defaultEmptyOK; // In this case an issue number has been provided
                             // (requires a javascript check in template!)
  ...
  /**
   * isTime returns true if string arguments hour, minute, and second form a
   * valid time.
   */
   ...
   * @return true, if the credit card number passes the Luhn Mod-10 test, false
   *         otherwise
   */
   ...
   * 
   * @param cc a string representing a credit card number; Sample number: 4111
   *          1111 1111 1111(16 digits)
   * @return true, if the credit card number is a valid VISA number, false
   *         otherwise
   */
   ...
   * 
   * @param cc a string representing a credit card number; Sample number: 5500
   *          0000 0000 0004(16 digits)
   * @return true, if the credit card number is a valid MasterCard number, false
   *         otherwise
   */
   ...
   * @return true, if the credit card number is a valid American Express number,
   *         false otherwise
   */
   ...
   * 
   * @param cc - a string representing a credit card number; Sample number:
   *          30000000000004(14 digits)
   * @return true, if the credit card number is a valid Diner's Club number,
   *         false otherwise
   */
   ...
   * @param cc - a string representing a credit card number; Sample number:
   *          30000000000004(14 digits)
   * @return true, if the credit card number is a valid Carte Blanche number,
   *         false otherwise
   */
   ...
   * 
   * @param cc - a string representing a credit card number; Sample number:
   *          6011000000000004(16 digits)
   * @return true, if the credit card number is a valid Discover card number,
   *         false otherwise
   */
   ...
   * 
   * @param cc - a string representing a credit card number; Sample number:
   *          201400000000009(15 digits)
   * @return true, if the credit card number is a valid enRoute card number,
   *         false, otherwise
   */
   ...
   * 
   * @param cc - a string representing a credit card number; Sample number:
   *          3088000000000009(16 digits)
   * @return true, if the credit card number is a valid JCB card number, false
   *         otherwise
   */
   ...
   * 
   * @param cc - a string representing a credit card number; Sample number:
   *          6331100000000096(16 digits)
   * @return true, if the credit card number is a valid Switch card number,
   *         false otherwise
   */
  public static boolean isswitch(String cc) {
    ...
    if (((cc.length() == 16) || (cc.length() == 18) || (cc.length() == 19))
        && (first4digs.equals("4903") || first4digs.equals("4905") || first4digs.equals("4911")
            || first4digs.equals("4936") || first6digs.equals("564182")
            || first6digs.equals("633110") || first4digs.equals("6333") || first4digs.equals("6759")))
      return isCreditCard(cc);
    return false;
  }
   ...
   * @param cc - a string representing a credit card number; Sample number:
   *          6331100000000096 (16 digits)
   * @return true, if the credit card number is a valid Solo card number, false
   *         otherwise
   */
   ...
   * 
   * @param cc - a string representing a credit card number; Sample number:
   *          4175000000000001(16 digits)
   * @return true, if the credit card number is a valid Visa Electron card
  ...
  /**
   * Checks to see if the cc number is a valid number for any accepted credit
   * card
   * 
   * @param ccPassed - a string representing a credit card number
   * @return true, if the credit card number is any valid credit card number for
   *         any of the accepted card types, false otherwise
   */
  public static boolean isAnyCard(String ccPassed) {
    ...
    if (isMasterCard(cc) || isVisa(cc) || isAmericanExpress(cc) || isDinersClub(cc)
        || isDiscover(cc) || isEnRoute(cc) || isJCB(cc) || isSolo(cc) || isswitch(cc)
        || isVisaElectron(cc))
      return true;
    return false;
  }
  ...
  /**
   * Checks to see if the cc number is a valid number for any accepted credit
   * card, and return the name of that type
   * 
   * @param ccPassed - a string representing a credit card number
   * @return true, if the credit card number is any valid credit card number for
   *         any of the accepted card types, false otherwise
   ...
   * @return true, if the credit card number is valid for the particular credit
   *         card type given in "cardType", false otherwise
   */
  public static boolean isCardMatch(String cardType, String cardNumberPassed) {
    ...
    if ((cardType.equalsIgnoreCase("ENROUTE")) && (isEnRoute(cardNumber)))
      return true;
    if ((cardType.equalsIgnoreCase("SOLO")) && (isSolo(cardNumber)))
      return true;
    if ((cardType.equalsIgnoreCase("SWITCH")) && (isswitch(cardNumber)))
      return true;
    if ((cardType.equalsIgnoreCase("VISAELECTRON")) && (isVisaElectron(cardNumber)))
      return true;
    return false;
  }

  /**
   * isNotPoBox returns true if address argument does not contain anything that
   * looks like a a PO Box.
   */
  ...
  public static char calcChecksum(String value, int length) {
    ...
    if (value == null || value.length() != length) {
      throw new IllegalArgumentException("Illegal size of value; must be either" + length + " or "
          + (length + 1) + " characters");
    }
    int oddsum = 0;
    int evensum = 0;
